...
<div class="clt_col_aside">
    <div class="clt_block_panel">
        ...
        <ul class="clt_accordion">
            <li>
                <div class="clt_accr_head">
                    <div class="clt_accr_div">
                        <span class="clt_accr_highlight clt_hl_price"><?=Yii::t('fhub', 'Currency')?> <span id="fcost2">0,000</span></span>
                        <span class="clt_tab_head"><?=Yii::t('fhub', 'Car loan monthly installment')?></span>
                    </div>
                </div>
                <div class="clt_accr_content">
                    <form action="#" id="finance-form" method="post">
                        ...
                        <div class="clt_form_foot">
                            <span class="clt_foot_highlight clt_hl_price"><?=Yii::t('fhub', 'Currency')?> <span id="fcost">0,000</span></span>
                            <span class="clt_tab_head"><?=Yii::t('fhub', 'Car loan monthly installment*')?>
                        </div>
                        <div class="clt_box_highlight">
                            <p class="clt_head_text"><?=Yii::t('fhub', 'Get today’s financing deal!');?></p>
                            <a href="<?=Url::to(['carfinance/index', 'ref_url' => $_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']], true)?>" target="_blank"><button type="button" class="clt_btn clt_btn_submit clt_btn_block clt_btn_lg clt_lead_button"><?=Yii::t('fhub', 'Request a quote')?></button></a><br />
                            <div style="text-align: center;"><a href="<?=Url::to(['carfinance/index', 'ref_url' => $_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']], true)?>" target="_blank" class="clt_post_author"><?=Yii::t('fhub', 'More information')?></a></div>
                        </div>
            ...
            <li>
                <div class="clt_accr_head">
                    <div class="clt_accr_div">
                        <span class="clt_accr_highlight clt_hl_price"><?=Yii::t('fhub', 'Currency')?> <span id="pcost2">0,000</span></span>
                        <span class="clt_tab_head"><?= Yii::t('fhub', 'Car insurance annual premium')?></span>
                    </div>
                </div>
                <div class="clt_accr_content">
                    <form action="#" id="insurance-form" method="post" onsubmit="return false;">
                        ...
                        <div class="clt_form_foot">
                            <span class="clt_foot_highlight clt_hl_price"><?=Yii::t('fhub', 'Currency')?> <span id="pcost">0,000</span></span>
                            <span class="clt_tab_head"><?=Yii::t('fhub', 'Car insurance annual premium*')?></span>
                        </div>
                        <div class="clt_box_highlight">
                            <p class="clt_head_text"><?=Yii::t('fhub', 'Get today’s insurance deal!');?></p>
                            <a href="<?=Url::to(['carfinance/index', 'ref_url' => $_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']], true)?>" target="_blank"><button type="button" class="clt_btn clt_btn_submit clt_btn_block clt_btn_lg clt_lead_button"><?=Yii::t('fhub', 'Request a quote')?></button></a><br />
                            <div style="text-align: center;"><a href="<?=Url::to(['carfinance/index', 'ref_url' => $_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']], true)?>" target="_blank" class="clt_post_author"><?=Yii::t('fhub', 'More information')?></a></div>
        ...
        <div class="clt_block_brought_by">
            <?=Yii::t('fhub', 'Brought<br>to you by')?>
