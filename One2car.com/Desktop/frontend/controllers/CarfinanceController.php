...
class CarfinanceController extends Controller
{
                ...
                $finance_featured_news = "<div class=\"clt_article_header\">
                                            <div class=\"clt_post_thumb\">
                                                <a href=\"http://carlist.my/news/$news->slug/$news->nid\" target='_blank'>
                                                    <img src=\"$news->image\" alt=\"$news->title\" class=\"clt_img_wide\" style='width:258px;'>
                                                </a>
                                            </div>
                                            <h3>
    ...
    public function actionFlead_signup(){
        ...
        if(empty($email) || empty($name) || empty($mobile)){
            ...
            $html = "<div class=\"clt_step_success_title\">".Yii::t('fhub', 'Submission successful!')."</div><p class=\"clt_text_center\">".Yii::t('fhub', 'Thank you for your interest. We will get back to you as soon as possible with the best offer suitable for you.')."</p><div class=\"clt_form_slim\"><div type=\"button\" class=\"clt_btn clt_btn_primary clt_btn_block clt_btn_lg\">".Yii::t('fhub', 'Call us')." ". ( $lead_type == "f" ? Yii::$app->params['finance_sponsor_phone'] : Yii::$app->params['insurance_sponsor_phone'] ) ."</div></div>";
            $json_data = [
                "status"         => "OK",
                "msg"            => $html,
            ];
