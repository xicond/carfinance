                                ...
                                <form action="#" method="post" id="flead-form">
                                    ...
                                    <div class="clt_step_content" id="fcon">
                                        ...
                                        <p class="clt_text_center">
                                            <button type="button" class="clt_btn clt_btn_submit clt_btn_lg clt_toggle_box clt_lead_button" data-toggle-target="request_quote1" style="width: 350px;"><?=Yii::t('fhub', 'Request a quote');?></button>
                                        </p>
                            ...
                            <div class="clt_step_panel clt_step_highlight clt_step_success">
                                <form action="#" method="post" id="ilead-form">
                                    ...
                                    <div class="clt_step_content" id="icon">
                                        ...
                                        <p class="clt_text_center">
                                            <button type="button" class="clt_btn clt_btn_submit clt_btn_lg clt_toggle_box clt_lead_button" data-toggle-target="request_quote2" style="width: 350px;"><?=Yii::t('fhub', 'Request a quote');?></button>
                                        </p>
