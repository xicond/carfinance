            ...
            <div class="clt_col_main">
                <div class="clt_tabs_container">
                    <ul class="clt_tabs clt_tabs_with_icons clt_tabs_outer" data-default='1'>
                        <li class="clt_tab_car_finance"><a href="#tab_car_finance" onclick="change_feed('f');"><?=Yii::t('fhub','Car Financing')?></a></li>
                            ...
                            <div class="clt_step_panel">
                                <form action="#" id="finance-form" method="post">
                                    <div class="clt_step_head">
                                        <strong>1</strong>
                                        <?=Yii::t('fhub', 'Calculate your car loan\'s monthly installment')?>
                                    </div>
                                    <div class="clt_step_content clt_form_horizontal">
                                        ...
                                        <div class="clt_form_group">
                                            ...
                                            <div class="clt_ctrl_block">
                                                <input type="number" class="clt_form_ctrl" name="deposit_amount" id="deposit_amount" placeholder="<?=Yii::t('fhub', 'Deposit Amount')?>" value="10000" onkeydown="return ( event.ctrlKey || event.altKey || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) || (95<event.keyCode && event.keyCode<106) || (event.keyCode==8) || (event.keyCode==9) || (event.keyCode>34 && event.keyCode<40) || (event.keyCode==46) )">
                                            </div>
                                        </div>
                                        <div class="clt_form_group">
                                            ...
                                            <div class="clt_ctrl_block">
                                                <input type="text" class="clt_form_ctrl" name="interest_rate" id="interest_rate" placeholder="<?=Yii::t('fhub', 'Interest Rate')?>" value="3" onkeydown="return ( event.ctrlKey || event.altKey || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) || (95<event.keyCode && event.keyCode<106) || (event.keyCode==8) || (event.keyCode==9) || (event.keyCode>34 && event.keyCode<40) || (event.keyCode==46) || (event.keyCode==190) )">
                                            </div>
                                        </div>
                                        <div class="clt_form_group">
                                            ...
                                            <div class="clt_ctrl_block">
                                                <input type="number" class="clt_form_ctrl" name="repayment_period" id="repayment_period" placeholder="<?=Yii::t('fhub', 'Repayment Period');?>" value="7" onkeydown="return ( event.ctrlKey || event.altKey || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) || (95<event.keyCode && event.keyCode<106) || (event.keyCode==8) || (event.keyCode==9) || (event.keyCode>34 && event.keyCode<40) || (event.keyCode==46) )">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clt_step_foot">
                                        <span class="clt_foot_highlight"><?=Yii::t('fhub', 'Currency')?> <span id="fcost">0,000</span></span>
                                        <span class="clt_foot_text"><?=Yii::t('fhub', 'Car loan<br>monthly installment*')?></span>
                                ...
                                <form action="#" method="post" id="flead-form">
                                    ...
                                    <div class="clt_step_content" id="fcon">
                                        ...
                                        <p class="clt_text_center">
                                            <button type="button" class="clt_btn clt_btn_submit clt_btn_lg clt_toggle_box clt_lead_button" data-toggle-target="request_quote1" style="width: 100%;"><?=Yii::t('fhub', 'Request a quote');?></button>
                                        </p>
                                        <div id="request_quote1" style="display: none;">
                                            <div class="clt_form_group">
                                            ...
                                            <div class="clt_form_group">
                                                <button type="submit" id="flead_button" class="clt_btn clt_btn_submit clt_btn_block clt_btn_lg clt_lead_button"><?=Yii::t('fhub', 'Request a quote');?></button>
                                                <div class="clt_sep_or"><span><?=Yii::t('fhub', 'or')?></span></div>
                                                <button type="submit" class="clt_btn clt_btn_primary clt_btn_block clt_btn_lg"><a href="tel:<?=Yii::$app->params['finance_sponsor_phone'];?>" style="color: white;"><?=Yii::t('fhub', 'Call us');?> <?=Yii::$app->params['finance_sponsor_phone'];?></a></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clt_step_foot">
                                        <div class="clt_brought_by">
                                            <span class="clt_brought_by_txt">
                                                <?=Yii::t('fhub','Brought to you by')?>
                                            </span>
                                            <span class="clt_brought_by_logo">
                                ...
                                <form action="#" id="insurance-form" method="post" onsubmit="return false;">
                                    ...
                                    <div class="clt_step_content clt_form_horizontal">
                                        ...
                                        <div class="clt_form_group">
                                            ...
                                            <div class="clt_ctrl_block">
                                                <input type="number" class="clt_form_ctrl" name="market_price" id="market_price" placeholder="<?=Yii::t('fhub', 'Market Price')?>" value="100000" onkeydown="return ( event.ctrlKey || event.altKey || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) || (95<event.keyCode && event.keyCode<106) || (event.keyCode==8) || (event.keyCode==9) || (event.keyCode>34 && event.keyCode<40) || (event.keyCode==46) )">
                                            </div>
                                        </div>
                                        <div class="clt_form_group">
                                        ...
                                        <div class="clt_form_group">
                                            <label for="engine_capacity" class="clt_ctrl_label">
                                        ...
                                        <div class="clt_form_group">
                                            <label for="no_claims_disc" class="clt_ctrl_label">
                                    ...
                                    <div class="clt_step_foot">
                                        ...
                                        <span class="clt_foot_text"><?=Yii::t('fhub', 'Car insurance annual premium*')?></span>
                            ...
                            <div class="clt_step_panel clt_step_highlight clt_step_success">
                                <form action="#" method="post" id="ilead-form">
                                    ...
                                    <div class="clt_step_content" id="icon">
                                        ...
                                        <p class="clt_text_center">
                                            <button type="button" class="clt_btn clt_btn_submit clt_btn_lg clt_toggle_box clt_lead_button" data-toggle-target="request_quote2" style="width: 100%;"><?=Yii::t('fhub', 'Request a quote');?></button>
                                        </p>
                                        <div id="request_quote2" style="display: none;">
                                            <div class="clt_form_group">
                                            ...
                                            <div class="clt_form_group">
                                                <button type="submit" id="ilead_button" class="clt_btn clt_btn_submit clt_btn_block clt_btn_lg clt_lead_button"><?=Yii::t('fhub', 'Request a quote');?></button>
                                                <div class="clt_sep_or"><span><?=Yii::t('fhub', 'or')?></span></div>
                                                <div type="submit" class="clt_btn clt_btn_primary clt_btn_block clt_btn_lg"><a href="tel:<?=Yii::$app->params['insurance_sponsor_phone'];?>" style="color: white;"><?=Yii::t('fhub', 'Call us');?> <?=Yii::$app->params['insurance_sponsor_phone'];?></a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clt_step_foot">
...
<input type="hidden" name="ref_url" id="ref_url" value="<?= (isset($_GET['ref_url']) && !empty(($_GET['ref_url']))) ? base64_encode("http://".$_GET['ref_url']) : ""?>">
<input type="hidden" name="nme" id="nme" value="<?=Yii::t('fhub', 'Please enter your name')?>">
<input type="hidden" name="phe" id="phe" value="<?=Yii::t('fhub', 'Please enter a valid contact number')?>">
